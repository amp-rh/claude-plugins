---
name: mpitt-expansion-reviewer
description: Reviews and fixes OCP expansion CI config YAML files against mpitt best practices. Scans config files in ci-operator/config/ for rule violations and applies fixes via StrReplace. Returns a JSON summary of detections/fixes. Does NOT perform any git operations. Use for reviewing expansion PRs, creating version bump configs, or validating FIPS/CR test entries in openshift/release.
---
