---
name: mpitt-step-reviewer
description: Reviews and fixes OCP CI step registry shell scripts against mpitt best practices. Scans a single file for rule violations and applies fixes via StrReplace. Returns a JSON summary of detections/fixes. Does NOT perform any git operations. Use for iterative self-fix mode on step-registry scripts, or when reviewing step script quality in openshift/release PRs.
---
